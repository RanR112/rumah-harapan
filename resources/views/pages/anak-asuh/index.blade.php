...
<div class="anak-asuh-page">
    ...
    <div class="page-header">
        <div class="page-header-content">
            ...
            <p class="page-description">
                Halaman pengelolaan data anak asuh Rumah Harapan untuk pendataan yang tertib dan konsisten.
            </p>
        </div>
        
        <!-- Action Buttons -->
        <div class="page-actions">
            <a href="{{ route('anak-asuh.create') }}" class="btn-primary">
    ...
    <div class="search-section">
        ...
        <div class="import-export-buttons">
            <!-- Export Button -->
            <form method="POST" action="{{ route('anak-asuh.export') }}" class="inline-form">
                @csrf
...
<div id="importModal" class="modal-overlay" style="display: none;">
    <div class="modal-container">
        ...
        <div class="modal-body">
            ...
            <form method="POST" action="{{ route('anak-asuh.import') }}" enctype="multipart/form-data" class="import-form">
                @csrf
                ...
                function closeOtherDropdowns() {
                    dropdowns.forEach(otherDropdown => {
                        if (otherDropdown !== dropdown) {
                            otherDropdown.querySelector('.custom-dropdown-menu').classList.remove('show');
                            otherDropdown.querySelector('.custom-dropdown-trigger').classList.remove('active');
                        }
                    });
                }
